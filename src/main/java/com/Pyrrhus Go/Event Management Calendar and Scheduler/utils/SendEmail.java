...
public class SendEmail {
  ...
  private static Credential getCredentials(final NetHttpTransport httpTransport, GsonFactory jsonFactory) throws IOException {
    InputStream in = SendEmail.class.getResourceAsStream("/client_secret_762985775959-0r7km4bhvur4no242mvifn0nq83khsr1.apps.googleusercontent.com.json");
    if (in == null) {
  ...
  void sentMail(String subject, String message, String recipient) throws Exception {
